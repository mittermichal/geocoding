-- based from https://github.com/osm2pgsql-dev/osm2pgsql/blob/da5a1d51ea94877ba59d8cadb16f5e9af1464c2a/flex-config/addresses.lua
...
local addrs = osm2pgsql.define_table({
    ...
    indexes = {
        ...
        { expression = 'lower(street)', method = 'btree' },
        { column = 'housenumber', method = 'btree' }
    },
    columns = {
